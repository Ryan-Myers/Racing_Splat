...
/* CAA30 800C9E30 10C0001A */  beqz       $a2, .L800C9E9C
/* CAA34 800C9E34 00A03825 */   or        $a3, $a1, $zero
/* CAA38 800C9E38 10850018 */  beq        $a0, $a1, .L800C9E9C
/* CAA3C 800C9E3C 00A4082A */   slt       $at, $a1, $a0
/* CAA40 800C9E40 54200008 */  bnel       $at, $zero, .L800C9E64
...
/* CAACC 800C9ECC 1000000E */  b          .L800C9F08
...
/* CAAE4 800C9EE4 10000008 */  b          .L800C9F08
...
/* CAB0C 800C9F0C 54200016 */  bnel       $at, $zero, .L800C9F68
...
/* CAB5C 800C9F5C 1000FFEA */  b          .L800C9F08
/* CAB60 800C9F60 ACADFFFC */   sw        $t5, -0x4($a1)
.L800C9F64:
/* CAB64 800C9F64 28C10010 */  slti       $at, $a2, 0x10
.L800C9F68:
/* CAB68 800C9F68 5420000E */  bnel       $at, $zero, .L800C9FA4
...
/* CAB98 800C9F98 1000FFF2 */  b          .L800C9F64
/* CAB9C 800C9F9C ACA9FFFC */   sw        $t1, -0x4($a1)
.L800C9FA0:
/* CABA0 800C9FA0 28C10004 */  slti       $at, $a2, 0x4
.L800C9FA4:
/* CABA4 800C9FA4 1420FFB5 */  bnez       $at, .L800C9E7C
...
/* CABBC 800C9FBC 1000FFF8 */  b          .L800C9FA0
...
/* CABCC 800C9FCC 14200005 */  bnez       $at, .L800C9FE4
...
/* CABDC 800C9FDC 1043000D */  beq        $v0, $v1, .L800CA014
/* CABE0 800C9FE0 00000000 */   nop
.L800C9FE4:
/* CABE4 800C9FE4 10C0FFAD */  beqz       $a2, .L800C9E9C
...
/* CAC3C 800CA03C 1000000E */  b          .L800CA078
...
/* CAC54 800CA054 10000008 */  b          .L800CA078
...
/* CAC7C 800CA07C 54200016 */  bnel       $at, $zero, .L800CA0D8
...
/* CACCC 800CA0CC 1000FFEA */  b          .L800CA078
/* CACD0 800CA0D0 ACAD0000 */   sw        $t5, 0x0($a1)
.L800CA0D4:
/* CACD4 800CA0D4 28C10010 */  slti       $at, $a2, 0x10
.L800CA0D8:
/* CACD8 800CA0D8 5420000E */  bnel       $at, $zero, .L800CA114
...
/* CAD08 800CA108 1000FFF2 */  b          .L800CA0D4
/* CAD0C 800CA10C ACA90000 */   sw        $t1, 0x0($a1)
.L800CA110:
/* CAD10 800CA110 28C10004 */  slti       $at, $a2, 0x4
.L800CA114:
/* CAD14 800CA114 1420FFB3 */  bnez       $at, .L800C9FE4
...
/* CAD2C 800CA12C 1000FFF8 */  b          .L800CA110
