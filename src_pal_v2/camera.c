...
#else
#pragma GLOBAL_ASM("asm_pal_v2/nonmatchings/camera/camera_init.s")
#endif
...
#else
#pragma GLOBAL_ASM("asm_pal_v2/nonmatchings/camera/func_80066CDC.s")
#endif
...
s32 render_sprite_billboard(Gfx **dlist, MatrixS **mtx, Vertex **vertexList, Object *obj, unk80068514_arg4 *arg4,
    ...
    if (flags & RENDER_VEHICLE_PART) {
        ...
        tanX = -sins_1(arctan2_f(sp44, diffZ)) >> 8;
        if (diffZ < 0.0f) {
            diffZ = -diffZ;
            tanX = 1 - tanX;
            tanY = -tanY;
